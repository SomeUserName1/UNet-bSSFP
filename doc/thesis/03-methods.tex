...
Finally, magnetization-prepared two rapid gradient-echo $T_1$-weighted images were acquired in one session sagitally at a resolution of $1$mm isotopic, with a TE of $2.98$ ms, TR of $5000$ms in a single shot fashion with a field of view of $256$mm and flip angles of $4^\circ$ and $5^\circ$. \\
...
\fig{img/pc-bssfp-mag.png}{pc-bssfp-mag}{A data sample of the first channel of the preprocessed bSSFP images that is fed into the neural network.}{1.0}
\fig{img/pc-bssfp-pha.png}{pc-bssfp-pha}{A data sample of the second channel of the preprocessed bSSFP images that is fed into the neural network.}{1.0}
...
\fig{img/augmentation.png}{augmentation}{Samples of the training data after data augmentation was applied (with a probability of $1$).}{0.4}
...
\fig{img/architecture.png}{arch}{The architecture of the model}{0.6}
