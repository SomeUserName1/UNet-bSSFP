...
#SBATCH --job-name=bssfp-dwi-i2i-translation
...
## SBATCH --mem=64000MB    # this one is not in effect, due to the double hash
#SBATCH --exclusive
...
srun singularity exec --nv --bind /ptmp/fklopfer/:/ptmp/fklopfer/ --bind /home/fklopfer/logs:/home/fklopfer/logs /ptmp/containers/python38.sif bash -c "python3 /home/fklopfer/UNet-bSSFP/src/train.py"
